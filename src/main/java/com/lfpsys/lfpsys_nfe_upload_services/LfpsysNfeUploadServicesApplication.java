package com.lfpsys.lfpsys_nfe_upload_services;
...
public class LfpsysNfeUploadServicesApplication {
	...
	public static void main(String[] args) {
		var application = new SpringApplication(LfpsysNfeUploadServicesApplication.class);
